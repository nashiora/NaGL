...
//		[DllImport(LIBRARY_GLU, SetLastError = true)] private static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.VertexData callback);
        ...
        /// <param name="op">Operation of the buffer.</param>
        /// <param name="value">Reference value.</param>
         public static void Accum(Enumerations.AccumOperation op, float value)
        {
            PreGLCall();
        ...
        /// <param name="reference">Specifies the reference	value that incoming alpha values are compared to. This value is clamped to the range 0	through	1, where 0 represents the lowest possible alpha value and 1 the highest possible value. The initial reference value is 0.</param>
         public static void AlphaFunc(Enumerations.AlphaTestFunction function, float reference)
        {
            PreGLCall();
        ...
        /// </summary>
        /// <param name="mode">The mode to draw in, e.g. OpenGL.POLYGONS.</param>
         public static void Begin(Enumerations.BeginMode mode)
        {
            // Do PreGLCall now, and PostGLCall AFTER End()
            PreGLCall();
        ...
        /// <param name="destinationFactor">The destination factor.</param>
         public static void BlendFunc(Enumerations.BlendingSourceFactor sourceFactor, Enumerations.BlendingDestinationFactor destinationFactor)
        {
            PreGLCall();
        ...
        /// <param name="type">Specifies the type of values in lists. Symbolic constants OpenGL.BYTE, OpenGL.UNSIGNED_BYTE, OpenGL.SHORT, OpenGL.UNSIGNED_SHORT, OpenGL.INT, OpenGL.UNSIGNED_INT, OpenGL.FLOAT, OpenGL.2_BYTES, OpenGL.3_BYTES and OpenGL.4_BYTES are accepted.</param>
        /// <param name="lists">Specifies the address of an array of name offsets in the display list. The pointer type is void because the offsets can be bytes, shorts, ints, or floats, depending on the value of type.</param>
         public static void CallLists(int n, Enumerations.DataType type, IntPtr lists)
        {
            PreGLCall();
        ...
        /// <param name="plane">Specifies which clipping plane is being positioned. Symbolic names of the form OpenGL.CLIP_PLANEi, where i is an integer between 0 and OpenGL.MAX_CLIP_PLANES -1, are accepted.</param>
        /// <param name="equation">Specifies the address of an	array of four double-precision floating-point values. These values are interpreted as a plane equation.</param>
         public static void ClipPlane(Enumerations.ClipPlaneName plane, double[] equation)
        {
            PreGLCall();
        ...
        /// <param name="function">The comparison function to set.</param>
         public static void DepthFunc(Enumerations.DepthFunction function)
		{
			PreGLCall();
        ...
        /// <param name="drawBufferMode">Specifies up to	four color buffers to be drawn into.</param>
         public static void DrawBuffer(Enumerations.DrawBufferMode drawBufferMode)
        {
            PreGLCall();
    ...
    /// <param name="nurbsObject">The nurbs object.</param>
        ...
        /// <param name="pname">The parameter to query.</param>
        /// <param name="parameters"></param>
         public static void GetBooleanv(Enumerations.GetTarget pname, byte[] parameters)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter to query.</param>
        /// <param name="parameters">The buffer to put that data into.</param>
         public static void GetDouble(Enumerations.GetTarget pname, double[] parameters)
        {
            PreGLCall();
        ...
        /// </summary>
        /// <returns>The current OpenGL error code.</returns>
        public static Enumerations.ErrorCode GetErrorCode()
        {
        ...
        /// <param name="pname">The parameter to query.</param>
        /// <param name="parameters">The parameters</param>
         public static void GetFloat(Enumerations.GetTarget pname, float[] parameters)
        {
            PreGLCall();
        ...
        /// <param name="pname">The Parameter to query</param>
        /// <param name="parameters">An array to put the values into.</param>
         public static void GetInteger(Enumerations.GetTarget pname, int[] parameters)
        {
            PreGLCall();
        ...
        /// <param name="query">Specifies which parameter to return.</param>
        /// <param name="v">Returns the requested data.</param>
         public static void GetMap(Enumerations.GetMapTarget target, uint query, double[] v)
        {
            PreGLCall();
        ...
        /// <param name="query">Specifies which parameter to return.</param>
        /// <param name="v">Returns the requested data.</param>
         public static void GetMap(Enumerations.GetMapTarget target, uint query, float[] v)
        {
            PreGLCall();
        ...
        /// <param name="query">Specifies which parameter to return.</param>
        /// <param name="v">Returns the requested data.</param>
         public static void GetMap(Enumerations.GetMapTarget target, uint query, int[] v)
        {
            PreGLCall();
        ...
        /// <param name="target">Specifies a symbolic constant indicating the behavior to be controlled.</param>
        /// <param name="mode">Specifies a symbolic constant indicating the desired behavior.</param>
         public static void Hint(Enumerations.HintTarget target, Enumerations.HintMode mode)
        {
            PreGLCall();
		...
		/// <param name="pname">The name of the parameter.</param>
		/// <param name="param">The parameter to set it to.</param>
         public static void LightModel(Enumerations.LightModelParameter pname, float param)
		{
			PreGLCall();
		...
		/// <param name="pname">The name of the parameter.</param>
		/// <param name="parameters">The parameter to set it to.</param>
         public static void LightModel(Enumerations.LightModelParameter pname, float[] parameters)
		{
			PreGLCall();
		...
		/// <param name="pname">The name of the parameter.</param>
		/// <param name="param">The parameter to set it to.</param>
         public static void LightModel(Enumerations.LightModelParameter pname, int param)
		{
			PreGLCall();
		...
		/// <param name="pname">The name of the parameter.</param>
		/// <param name="parameters">The parameter to set it to.</param>
         public static void LightModel(Enumerations.LightModelParameter pname, int[] parameters)
		{
			PreGLCall();
        ...
        /// <param name="pname">The parameter you want to set.</param>
        /// <param name="param">The value that you want to set the parameter to.</param>
         public static void Light(Enumerations.LightName light, Enumerations.LightParameter pname, float param)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter you want to set.</param>
        /// <param name="parameters">The value that you want to set the parameter to.</param>
         public static void Light(Enumerations.LightName light, Enumerations.LightParameter pname, float[] parameters)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter you want to set.</param>
        /// <param name="param">The value that you want to set the parameter to.</param>
         public static void Light(Enumerations.LightName light, Enumerations.LightParameter pname, int param)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter you want to set.</param>
        /// <param name="parameters">The parameters.</param>
         public static void Light(Enumerations.LightName light, Enumerations.LightParameter pname, int[] parameters)
        {
            PreGLCall();
        ...
        /// <param name="logicOp">Specifies a symbolic constant	that selects a logical operation.</param>
         public static void LogicOp(Enumerations.LogicOp logicOp)
        {
            PreGLCall();
		...
		/// </summary>
		/// <param name="mode">The mode, normally PROJECTION or MODELVIEW.</param>
         public static void MatrixMode(Enumerations.MatrixMode mode)
		{
			PreGLCall();
    ...
    /// <param name="type">The type of data to generate.</param>
        ...
        /// <param name="pname">Specifies the symbolic name of the pixel transfer parameter to be set.</param>
        /// <param name="param">Specifies the value that pname is set to.</param>
         public static void PixelTransfer(Enumerations.PixelTransferParameterName pname, bool param)
        {
            PreGLCall();
            int p = param ? 1 : 0;
        ...
        /// <param name="pname">Specifies the symbolic name of the pixel transfer parameter to be set.</param>
        /// <param name="param">Specifies the value that pname is set to.</param>
         public static void PixelTransfer(Enumerations.PixelTransferParameterName pname, float param)
        {
            PreGLCall();
        ...
        /// <param name="pname">Specifies the symbolic name of the pixel transfer parameter to be set.</param>
        /// <param name="param">Specifies the value that pname is set to.</param>
         public static void PixelTransfer(Enumerations.PixelTransferParameterName pname, int param)
        {
            PreGLCall();
        ...
        /// <param name="face">The faces this applies to (front, back or both).</param>
        /// <param name="mode">The mode to set to (points, lines, or filled).</param>
         public static void PolygonMode(Enumerations.FaceMode face, Enumerations.PolygonMode mode)
        {
            PreGLCall();
        ...
        /// </summary>
        /// <param name="mask">The attibute groups to save.</param>
         public static void PushAttrib(Enumerations.AttributeMask mask)
        {
            PreGLCall();
        ...
        /// <param name="mode">The Render mode (RENDER, SELECT or FEEDBACK).</param>
        /// <returns>The hits that selection or feedback caused..</returns>
        public static int RenderMode(Enumerations.RenderingMode mode)
        {
            PreGLCall();
        ...
        /// </summary>
        /// <param name="mode">Specifies a symbolic value representing a shading technique. Accepted values are OpenGL.FLAT and OpenGL.SMOOTH. The default is OpenGL.SMOOTH.</param>
         public static void ShadeModel(Enumerations.ShadeModel mode)
        {
            PreGLCall();
        ...
        /// <param name="reference">The function reference.</param>
        /// <param name="mask">The function mask.</param>
         public static void StencilFunc(Enumerations.StencilFunction func, int reference, uint mask)
        {
            PreGLCall();
		...
		/// <param name="zfail">Depth fail component.</param>
		/// <param name="zpass">Depth pass component.</param>
         public static void StencilOp(Enumerations.StencilOperation fail, Enumerations.StencilOperation zfail, Enumerations.StencilOperation zpass)
		{
			PreGLCall();
        ...
        /// <param name="pname">The parameter to set.</param>
        /// <param name="param">The value to set it to.</param>
         public static void TexParameter(Enumerations.TextureTarget target, Enumerations.TextureParameter pname, float param)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter to set.</param>
        /// <param name="parameters">The value to set it to.</param>
         public static void TexParameter(Enumerations.TextureTarget target, Enumerations.TextureParameter pname, float[] parameters)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter to set.</param>
        /// <param name="param">The value to set it to.</param>
         public static void TexParameter(Enumerations.TextureTarget target, Enumerations.TextureParameter pname, int param)
        {
            PreGLCall();
        ...
        /// <param name="pname">The parameter to set.</param>
        /// <param name="parameters">The value to set it to.</param>
         public static void TexParameter(Enumerations.TextureTarget target, Enumerations.TextureParameter pname, int[] parameters)
        {
            PreGLCall();
